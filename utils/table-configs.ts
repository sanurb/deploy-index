import type { StickyColumnConfig, TableConfig } from "@/components/table/core";
...
export const TABLE_CONFIGS: Record<TableId, TableConfig> = {
  ...
  services: {
    tableId: "services",
    stickyColumns: STICKY_COLUMNS.services,
    sortFieldMap: SORT_FIELD_MAPS.services,
    nonReorderableColumns: NON_REORDERABLE_COLUMNS.services,
    rowHeight: ROW_HEIGHTS.services,
  },
};
